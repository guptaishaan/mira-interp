...
SEEDS = causal.SEEDS
CODE = causal.CODE + ["scripts/rollout_steering.py", "src/mira_interp/rollout_steering.py",
...
def main():
    ...
    parser.add_argument("--selection-audit", type=Path, default=ROOT / "results/rollout_steering_v1/selection_audit.json")
    parser.add_argument("--output-dir", type=Path, default=ROOT / "results/rollout_steering_v1")
    parser.add_argument("--artifact-dir", type=Path, default=Path("/data2/ishaangp/mira-interp/rollout_steering_v1"))
